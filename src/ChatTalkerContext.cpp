...
bool handle_auth_twitch_clicked(obs_properties_t *props, obs_property_t *property, void *data) {
...
obs_properties_t *ChatTalkerContext::getProperties(void)
{
    ...
    obs_properties_add_button2(authGroup, "authTwitch", obs_module_text("AuthTwitch"), handle_auth_twitch_clicked, this);
    obs_properties_add_group(props, "auth", obs_module_text("AuthGroup"), OBS_GROUP_NORMAL, authGroup);

	return props;
}

bool ChatTalkerContext::handleAuthTwitchClicked(obs_properties_t *props, obs_property_t *property) {
